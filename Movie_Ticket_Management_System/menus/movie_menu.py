...
from services.movie_services import add_movie, view_movies, search_movie, update_movie, delete_movie
console = Console()
...
def menu():
    while True:
        try:
            ...
            elif choice == "2": view_movies()
            elif choice == "3": search_movie()
            elif choice == "4": update_movie()
            elif choice == "5": delete_movie()
            elif choice == "6":
